...
create_visitor!(ast: {
    ...
    #[cfg(feature = "luau")] {
        ...
        visit_declared_global_function => DeclaredGlobalFunction,
        visit_declared_extern_type => DeclaredExternType,
        visit_declared_class => DeclaredClass,
        visit_declared_function_signature => DeclaredFunctionSignature,
        visit_declared_function_signature_parameter => DeclaredFunctionSignatureParameter,
        visit_declared_extern_type_name => DeclaredExternTypeName,
        visit_declared_extern_type_member => DeclaredExternTypeMember,
        visit_declared_extern_type_property => DeclaredExternTypeProperty,
        visit_declared_extern_type_index_signature => DeclaredExternTypeIndexSignature,
        visit_declared_extern_type_method => DeclaredExternTypeMethod,
