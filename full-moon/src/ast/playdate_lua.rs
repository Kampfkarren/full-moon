//! Contains the nodes necessary to parse [Playdate's custom Lua syntax](https://sdk.play.date/2.5.0/Inside%20Playdate.html#developing-in-lua).
//! Only usable when the "playdate" feature flag is enabled.
