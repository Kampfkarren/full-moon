...
use super::{punctuated::Punctuated, span::ContainedSpan, Expression, FunctionBody};
use crate::{
    tokenizer::{Token, TokenReference, TokenType}, util::{display_option, join_vec}, visitors::{Visit, VisitMut}, ShortString
};
#[cfg(feature = "serde")]
...
/// An if expression
pub type IfExpression = crate::ast::ifexpr::IfExpression;

/// An elseif expression in a bigger [`IfExpression`] expression
pub type ElseIfExpression = crate::ast::ifexpr::ElseIfExpression;
